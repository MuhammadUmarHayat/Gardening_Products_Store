...
if($userType=="admin")
{
    ...
    $result = $con->query("SELECT * FROM `admins` WHERE `userid`='$userid' and `password`='$password'");
...
{
    $result = $con->query("SELECT * FROM `users` WHERE `userid`='$userid' and `password`='$password'");
...
<table>
  ...
  <option value="customer">Customer</option>
    ...
    <td><input type="text" name="userid" Required/></td><td></td>
</tr>
    <tr><td>Enter user password</td>
    <td><input type="password" name="password" Required/></td><td>*</td></tr>
    <tr><td></td>
    <td><input class="button2" type="submit" name="submit"  value="Login"/></td><td></td>
</tr>
<tr><td></td>
