...
$result = $con->query("SELECT * FROM `plants_table` WHERE `category`='Summer Plants' or `category`='Winter Plants' or `category`='Indoor Plants' or `category`='Outdoor Plants'");
...
<?php  if ($result->num_rows > 0) 
{
 ...
 <p> <h4><?php echo $row['description'] ?></h4></p>
  <p><a class="button1" href="about.php" class="info">View </a></p>
